...
# require "action_mailbox/engine" # can't load engine as it loads all of rails and expects an app
...
#ActionDispatch::IntegrationTest.include(Rails.application.routes.mounted_helpers)

# Rails::Conductor::ActionMailbox::InboundEmailsControllerTest#test_create_inbound_email_with_bcc:
# NameError: undefined local variable or method `main_app' for an instance of Rails::Conductor::ActionMailbox::InboundEmailsController
#     app/controllers/rails/conductor/action_mailbox/inbound_emails_controller.rb:20:in `create'
